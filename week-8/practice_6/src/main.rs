fn main() {
	...
	let _datatype_tuple: (&str, f32, u8) = ("Rust", 3.14, 100);
	println!("Tuple contents = {:?}", _datatype_tuple);
	...
	println!("Value at Index 0 = {}", _datatype_tuple.0);

	//accessing tuple  element at index 1
	println!("Value at Index 1 = {}", _datatype_tuple.1);

	// accessing tuple element at index 2
	println!("Value at Index 2 = {}", _datatype_tuple.2);
}