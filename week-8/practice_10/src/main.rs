fn main() {
	...
	//This means the slice starts from index 0 and goes up to indesx 3 (exclusive)
	println!("index 0 to index 3 sliced = {:?}", slice2);

	//omit the end index
	let slice3 = &numbers[2..];
	//This means the slice startsx from index 2 and goes up to index 5 (exclusive)
	...
	println!("index 0 to index 5 sliced is {:?}", slice4);
}